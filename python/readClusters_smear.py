...
if __name__ == "__main__":
    ...
    #file_list = get_list_of_files(directory)
    #occ_map = make_cluster_map(file_list)  
    #np.save('design_0_no_outer_ge_2pix_smear_phifix.npy', occ_map)
    ...
    #file_list = get_list_of_files(directory)
    #occ_map = make_cluster_map(file_list)  
    #np.save('design_0p1_no_outer_ge_2pix_smear_phifix.npy', occ_map)
    directory = '/mnt/hadoop/user/uscms01/pnfs/unl.edu/data4/cms/store/user/eschmitz/PixelTrees/RelValTTbar_13TeV/crab_RelValTTbar_13TeVdesign_0p1_I_GEN/190819_222205/0000/'
    ...
    file_list = get_list_of_files(directory)
    occ_map = make_cluster_map(file_list)  
    np.save('design_0p1_0p08_no_outer_ge_2pix_smear_phifix.npy', occ_map)
    ...
    file_list = get_list_of_files(directory)
    occ_map = make_cluster_map(file_list)  
    np.save('design_0p5_no_outer_ge_2pix_smear_phifix.npy', occ_map)
