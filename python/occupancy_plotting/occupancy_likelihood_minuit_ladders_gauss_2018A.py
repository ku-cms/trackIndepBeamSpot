...
def remake_arrays(input_arr_):
    ...
    for roc in roc_index:
        ...
        if 35 < int((roc/12)%64) < 40 and roc%12==0: continue
        if 35 < int((roc/12)%64) < 40 and roc%12==1: continue
        ...
        if int((roc/12)%64) == 16 and roc%12==0: continue
        if int((roc/12)%64) == 32 and roc%12==0: continue
        if int((roc/12)%64) == 42 and roc%12==0: continue
        if int((roc/12)%64) == 56 and roc%12==0: continue
        if int((roc/12)%64) == 55 and roc%12==0: continue

        if int((roc/12)%64) == 33 and roc%12==1: continue
        if int((roc/12)%64) == 34 and roc%12==1: continue

        if int((roc/12)%64) == 18 and roc%12==2: continue
        if int((roc/12)%64) == 27 and roc%12==2: continue
        if int((roc/12)%64) == 27 and roc%12==2: continue
        if int((roc/12)%64) == 31 and roc%12==2: continue
        if int((roc/12)%64) == 34 and roc%12==2: continue
        if int((roc/12)%64) == 46 and roc%12==2: continue
        if int((roc/12)%64) == 44 and roc%12==2: continue
        if int((roc/12)%64) == 55 and roc%12==2: continue
        if int((roc/12)%64) == 40 and roc%12==2: continue

        if 18 <int((roc/12)%64) < 24 and roc%12==4: continue
        if int((roc/12)%64) == 15 and roc%12==4: continue
        if int((roc/12)%64) == 11 and roc%12==4: continue
        if int((roc/12)%64) == 16 and roc%12==4: continue
        if int((roc/12)%64) == 28 and roc%12==4: continue
        if int((roc/12)%64) == 24 and roc%12==4: continue
        if int((roc/12)%64) == 39 and roc%12==4: continue
        if int((roc/12)%64) == 36 and roc%12==4: continue
        if int((roc/12)%64) == 32 and roc%12==4: continue
        if int((roc/12)%64) == 44 and roc%12==4: continue
        if int((roc/12)%64) == 50 and roc%12==4: continue

        if 18 <int((roc/12)%64) < 24 and roc%12==5: continue
        if int((roc/12)%64) == 12 and roc%12==5: continue
        if int((roc/12)%64) == 38 and roc%12==5: continue
        if int((roc/12)%64) == 36 and roc%12==5: continue
        if int((roc/12)%64) == 45 and roc%12==5: continue
        if int((roc/12)%64) == 43 and roc%12==5: continue
        if int((roc/12)%64) == 42 and roc%12==5: continue
        if int((roc/12)%64) == 41 and roc%12==5: continue

        if int((roc/12)%64) == 25 and roc%12==6: continue
        if int((roc/12)%64) == 29 and roc%12==6: continue
        if int((roc/12)%64) == 16 and roc%12==6: continue
        if int((roc/12)%64) == 18 and roc%12==6: continue
        if int((roc/12)%64) == 23 and roc%12==6: continue
        if int((roc/12)%64) == 22 and roc%12==6: continue
        if int((roc/12)%64) == 8 and roc%12==6: continue
        if int((roc/12)%64) == 9 and roc%12==6: continue
        if int((roc/12)%64) == 11 and roc%12==6: continue
        if int((roc/12)%64) == 12 and roc%12==6: continue
        if int((roc/12)%64) == 15 and roc%12==6: continue
        if 35 < int((roc/12)%64) < 40 and roc%12==6: continue
        if int((roc/12)%64) == 33 and roc%12==6: continue
        if int((roc/12)%64) == 34 and roc%12==6: continue
        if int((roc/12)%64) == 47 and roc%12==6: continue
        if int((roc/12)%64) == 46 and roc%12==6: continue
        if int((roc/12)%64) == 42 and roc%12==6: continue
        if int((roc/12)%64) == 41 and roc%12==6: continue
        if int((roc/12)%64) == 49 and roc%12==6: continue
        if int((roc/12)%64) == 48 and roc%12==6: continue

        if int((roc/12)%64) == 19 and roc%12==7: continue
        if int((roc/12)%64) == 20 and roc%12==7: continue
        if int((roc/12)%64) == 21 and roc%12==7: continue
        if int((roc/12)%64) == 23 and roc%12==7: continue
        if int((roc/12)%64) == 16 and roc%12==7: continue
        if int((roc/12)%64) == 29 and roc%12==7: continue
        if int((roc/12)%64) == 37 and roc%12==7: continue
        if int((roc/12)%64) == 32 and roc%12==7: continue
        if int((roc/12)%64) == 45 and roc%12==7: continue
        if int((roc/12)%64) == 44 and roc%12==7: continue
        if int((roc/12)%64) == 42 and roc%12==7: continue
        if int((roc/12)%64) == 52 and roc%12==7: continue
        if int((roc/12)%64) == 53 and roc%12==7: continue
        if int((roc/12)%64) == 50 and roc%12==7: continue

        if int((roc/12)%64) == 25 and roc%12==8: continue
        if int((roc/12)%64) == 39 and roc%12==8: continue
        if int((roc/12)%64) == 37 and roc%12==8: continue
        if int((roc/12)%64) == 55 and roc%12==8: continue
        if int((roc/12)%64) == 53 and roc%12==8: continue
        if 7 < int((roc/12)%64) < 16 and roc%12==8: continue

        if int((roc/12)%64) == 21 and roc%12==9: continue
        if int((roc/12)%64) == 19 and roc%12==9: continue
        if int((roc/12)%64) == 16 and roc%12==9: continue
        if int((roc/12)%64) == 25 and roc%12==9: continue
        if int((roc/12)%64) == 39 and roc%12==9: continue
        if int((roc/12)%64) == 40 and roc%12==9: continue

        if int((roc/12)%64) == 19 and roc%12==10: continue
        if int((roc/12)%64) == 20 and roc%12==10: continue
        if int((roc/12)%64) == 21 and roc%12==10: continue
        if int((roc/12)%64) == 23 and roc%12==10: continue
        if int((roc/12)%64) == 36 and roc%12==10: continue
        if int((roc/12)%64) == 28 and roc%12==10: continue
        if int((roc/12)%64) == 30 and roc%12==10: continue
        if int((roc/12)%64) == 31 and roc%12==10: continue
        if int((roc/12)%64) == 44 and roc%12==10: continue
        if int((roc/12)%64) == 43 and roc%12==10: continue
        if int((roc/12)%64) == 55 and roc%12==10: continue
        if int((roc/12)%64) == 52 and roc%12==10: continue

        if int((roc/12)%64) == 31 and roc%12==11: continue
    ...
    #remove_z = (z_array > -15) * (z_array < 15)
    ...
    minuit = im.Minuit(nll, x0=0., y0=0., z0=0., n=1,
                       ...
                       #fix_z0=True,
                       limit_x0=(-1, 1), limit_y0=(-1, 1), limit_z0=(-10, 10),
                       #limit_b1=(0.2, None),
...
if __name__ == "__main__":
    ...
    #in_array = read_file("design_0p1_no_outer_all_pix_smear_tracks.npy")
    #in_array = read_file("design_0p1_no_outer_all_pix_smear_notracks.npy")
    #in_array = read_file("design_0p1_no_outer_all_pix_smear_charge_l1000.npy")
    #in_array = read_file("design_0p1_no_outer_all_pix_smear_charge_l1000_size_1_50.npy")
    #in_array = read_file("design_0p1_no_outer_all_pix_smear_size_1.npy")
    #in_array = read_file("design_0p1_no_outer_all_pix_smear_size_1_50.npy")
    ...
    #in_array = read_file("singlemu_2018A_no_outer_all_pix.npy")
